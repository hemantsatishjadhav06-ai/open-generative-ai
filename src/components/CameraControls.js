...
export function CameraControls(onChange) {
    ...
    const createColumn = (title, items, key, initialValue) => {
        ...
        viewport.className = 'relative overflow-hidden w-full h-[40vh] md:h-[320px] bg-[#15253b]/80 rounded-[2rem] border border-white/5 shadow-2xl backdrop-blur-xl transition-transform duration-300 hover:scale-[1.02] hover:border-white/10';
        ...
        topMask.className = 'absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-[#15253b] via-[#15253b]/80 to-transparent z-20 pointer-events-none rounded-t-[2rem]';
        viewport.appendChild(topMask);

        const bottomMask = document.createElement('div');
        bottomMask.className = 'absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#15253b] via-[#15253b]/80 to-transparent z-20 pointer-events-none rounded-b-[2rem]';
