    ...
    modal.innerHTML = `
        ...
        <div class="flex flex-col items-center text-center mb-8">
            <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center border border-primary/20 shadow-glow mb-6">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#2ee6d6" stroke-width="2">
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col gap-3">
                <button id="save-key-btn" class="w-full bg-primary text-on-brand font-black py-4 rounded-2xl hover:shadow-glow hover:scale-[1.02] active:scale-[0.98] transition-all">
                    ${t('auth.initBtn')}
                </button>
