...
// Never let secrets, identifiers or user content into analytics.
const BLOCKED_KEYS = new Set([
    'key', 'apiKey', 'api_key', 'prompt', 'url', 'resultUrl', 'email',
    'code', 'accessCode', 'access_code', 'session', 'sessionId', 'sid', 'cookie', 'token', 'workspace',
]);
