// Minimal structured logging helpers (the gateway's own logger in
// lib/gateway/log.js uses newReqId). Plain ESM, no deps, works in the edge
// runtime too. Only the named fields are ever logged: never headers, keys,
// cookies, access codes, request/response bodies, full paths or query strings.
