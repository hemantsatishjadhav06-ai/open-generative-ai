  ...
  return (
    <main className="min-h-screen bg-surface-app text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-gradient shadow-glow" aria-hidden="true">
        ...
        <Link
          ...
          className="mt-8 inline-flex items-center justify-center rounded-2xl bg-brand px-6 py-3 text-sm font-semibold text-on-brand shadow-glow transition-colors hover:bg-brand-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/60"
        >
          {copy.cta}
        </Link>
        <nav aria-label={copy.popular} className="mt-8">
          <p className="mb-3 text-[12px] font-medium text-secondary">{copy.popular}</p>
